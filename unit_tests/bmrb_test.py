...
class TestPyNMRSTAR(unittest.TestCase):
    ...
    def test__InterpretFile(self):
        ...
        self.assertEqual(pynmrstar._interpret_file("http://rest.pynmrstar.wisc.edu/bmrb/NMR-STAR3/15000").read(), local_version)
        self.assertEqual(pynmrstar._interpret_file("ftp://ftp.pynmrstar.wisc.edu/pub/bmrb/entry_directories/bmr15000/bmr15000_3.str").read(), local_version)

        # Test reading from https locations
        # TODO: re-enable once API is updated
        #self.assertEqual(pynmrstar._interpret_file("https://webapi.pynmrstar.wisc.edu/v2/entry/15000?format=rawnmrstar").read(), local_version)
    ...
    def test_Schema(self):
        ...
        loaded = pynmrstar.Schema(pynmrstar._SCHEMA_URL)
